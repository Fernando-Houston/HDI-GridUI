...
function App() {
  ...
  const [leads, setLeads] = useState<Lead[]>([
    ...
    },
    {
      ...
      gridPosition: { x: 350, y: 250, size: 70 },
      addedDate: new Date('2025-01-01'),
      status: 'interested',
      notes: '$0.0'
    },
    {
      ...
      investmentScore: 70,
      neighborhoodTrend: { trend: 'stable', yoyChange: 3.1 },
      gridPosition: { x: 450, y: 400, size: 65 },
      addedDate: new Date('2025-01-01'),
      status: 'interested',
      notes: '$137,000'
    },
    {
      ...
      gridPosition: { x: 600, y: 350, size: 60 },
      addedDate: new Date('2025-01-01'),
      status: 'interested',
      notes: '$150,000'
    },
    {
      ...
      gridPosition: { x: 300, y: 350, size: 75 },
    ...
    },
    {
      ...
      gridPosition: { x: 550, y: 450, size: 85 },
    ...
    },
    {
      ...
      gridPosition: { x: 400, y: 200, size: 55 },
    ...
    },
    {
      ...
      gridPosition: { x: 650, y: 250, size: 65 },
    ...
    },
    {
      ...
      gridPosition: { x: 250, y: 400, size: 70 },
      addedDate: new Date('2025-06-01'),
      status: 'interested',
      notes: '$135,000'
    },
    {
      ...
      investmentScore: 67,
      neighborhoodTrend: { trend: 'stable', yoyChange: 3.5 },
      gridPosition: { x: 700, y: 400, size: 58 },
      addedDate: new Date('2025-01-01'),
      status: 'interested',
      notes: '$103,000'
    },
    {
      ...
      gridPosition: { x: 450, y: 500, size: 62 },
      addedDate: new Date('2025-01-01'),
      status: 'interested',
      notes: '$99,000'
    },
    {
      ...
      gridPosition: { x: 350, y: 500, size: 78 },
      addedDate: new Date('2025-04-01'),
      status: 'interested',
      notes: '$180,000'
    },
    {
      ...
      investmentScore: 66,
      neighborhoodTrend: { trend: 'stable', yoyChange: 3.3 },
      gridPosition: { x: 550, y: 200, size: 52 },
      addedDate: new Date('2025-01-01'),
      status: 'interested',
      notes: '$99,000'
    },
    {
      ...
      investmentScore: 72,
      neighborhoodTrend: { trend: 'warming', yoyChange: 4.5 },
      gridPosition: { x: 200, y: 300, size: 72 },
    ...
    },
    {
      ...
      gridPosition: { x: 600, y: 500, size: 68 },
      addedDate: new Date('2025-01-01'),
      status: 'interested',
      notes: '$113,000'
    },
    {
      ...
      investmentScore: 68,
      neighborhoodTrend: { trend: 'stable', yoyChange: 3.7 },
      gridPosition: { x: 750, y: 300, size: 56 },
      addedDate: new Date('2025-11-01'),
      status: 'interested',
      notes: '$113,000'
    },
    {
      ...
      gridPosition: { x: 150, y: 450, size: 74 },
